...
export default function IntroductoryText() {
  ...
  const lines = [
    "Before the world floods in, there is a moment. A pause. A stillness.",
    "Tone is that moment—a sensory reset, a place to find your signal",
    "amidst the static, to reconnect with your thoughts on a clear, single note.",
  ];
